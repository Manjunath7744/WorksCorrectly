...
$('#callMeLaterSubmit').click(function () {
    ...
    var dealerCode = $('#PkDealercode').val();
    if (dealerCode == "GALAXYTOYOTA" || dealerCode == "HARPREETFORD" || dealerCode == "HANSHYUNDAI" || dealerCode == "TOYOTADEMO" ) {
...
$('#renewalId').click(function () {
    ...
    if ($("#AlreadyServiced").prop('checked') == true) {
        ...
        if ($("#ServicedMyDealer").is(":checked")) {
            ...
            if (dealerCode == "MAHALAXMIAUTOMOTIVE") {
                if (lastservDate == "" || worklist == "" || insPrvded == "") {
                    Lobibox.notify('warning', {
                        continueDelayOnInactiveTab: true,
