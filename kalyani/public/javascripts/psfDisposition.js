...
$('#notInterestedSubmit').click(function(){
	var noIntrest = $('#remarksValueForNoIntrst').val();
	if(noIntrest == ''){
		Lobibox.notify('warning', {
							continueDelayOnInactiveTab: true,
...
$('#notCallMeLaterSubmit').click(function(){
	var callLaterFrom = $('#time_ToIn').val();
	var callLaterTO = $('#time_FromIn').val();
if(callLaterTO == '' ){
		Lobibox.notify('warning', {
							continueDelayOnInactiveTab: true,
...
$("input[name$='satisfiedWithWashingSelfD']").click(function() {
 ...
 $("input[name='isContacted']").click(function() {
	...
	$("input[name$='disposition']").click(function(){
		varPSFYes = $(this).val();
		if(varPSFYes == "PSF_Yes" || varPSFYes == "Call Me Later" || varPSFYes == "Not Interested")
		{
			psfNamaskar();
		}
});
...
function psfNamaskar(){
 ...
 $("input[name$='modeOfService']").click(function() {
        var varPSF1Yes = $(this).val();
		if(varPSF1Yes=="PSFSelf Yes")
		{
	...
	$('#dropDownCheckedSelect1').change(function()
                {
                    varChecked=$('#dropDownCheckedSelect1').val()
                    if(varChecked =='Self Drive-in' || varChecked =='Pick-Up' || varChecked =='MMS')
                    {
						dropDownCheck();
                    }
...
//$("#PsfSelfDriveInNo1").show();
$(".6thDayPSF").hide();
$('#dropDownCheckedSelect1').val('0');
	$("input:radio[name='modeOfService']").each(function(i) {
       this.checked = false;
});
...
$('#PSF1Yess').click(function(){
var valueOfPd =$('#selectServiceMode').text();

if(valueOfPd =='Self Drive-in'){
 $(".6thDayPSF").show();
$('#SelfDriveIn1Div').hide();
$('#PsfSelfDriveInNo1').hide();
$('#PickUp1Div').hide();
...
$("#MMS1Div").show();
	...
	$("#PSF1Yess").prop("disabled",true);
	Lobibox.alert('warning', {
		continueDelayOnInactiveTab: true,
		msg: 'Please Choose No.'
	});
