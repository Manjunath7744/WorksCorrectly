$(document).ready(function () {
    ...
    $("input[name='psfinteraction.remarks']").click(function () {
    ...
    $("input[name='psfinteraction.remarksDissatisfied']").click(function () {
...
//kalyani psf form validation 

$('#BackTo10thQuestionMMSSubmitKalyani').click(function () {
    var v1FB = $("input[name=modeOfServiceDone]:checked").val();
    var v2FB = $("input[name=qFordQ1]:checked").val();
    var v3FB = $("input[name=qFordQ2]:checked").val();
    var v4FB = $("input[name=qFordQ3]:checked").val();
    var v5FB = $("input[name=qFordQ5]:checked").val();
    var v6FB = $("input[name=qFordQ6]:checked").val();
    var v7FB = $("input[name=qFordQ7]:checked").val();
    var v8FB = $("input[name=qFordQ9]:checked").val();
    //alert(vFB);
